...
import { Transaction, ApproveRequest } from "declaration/token/token.did";
import { TOKEN_STANDARD } from "constants/tokens";

export type { Metadata as DIP20Metadata } from "constants/dip20/dip20";
...
export type {
  ...
  TransactionRequest,
} from "declaration/token/token.did";
