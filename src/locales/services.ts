...
export const IDOLocals: Locals = {
  IDO_detail_not_exist: t`IDO_detail_not_exist`,
  "IDOService.deposit#transfer failed": t`Failed to transfer`,
  "IDOService.deposit#Get_IDO_Property_failed.": t`Failed to get IDO property`,
  "IDOService.withdraw#Get_IDO_Property_failed": t`Failed to get IDO property`,
  "IDOService._setStatus#Get_IDO_Property_failed.": t`Failed to get IDO property`,
  "IDOService.addParticipant#Get_IDO_Property_failed.": t`Failed to get IDO property`,
  "IDOService.complete#strategy distribute failed": t`Failed to strategy distribute`,
  "IDOService.complete#participants do not exist": t`Participants do not exist`,
  "IDOService.getParticipantDetail#Can_Not_Find_Corresponding_Participant.": t`Can't find corresponding participant.`,
  "IDOService.getParticipantDetail#Get_IDO_Property_failed.": t`Failed to get IDO property.`,
...
export const getLaunchpadMessage = (message: string | undefined): string | undefined => {
  return message ? IDOLocals[message] ?? message : undefined;
};
