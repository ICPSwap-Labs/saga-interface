...
export interface _SERVICE {
  ...
  'collectInInvalidPosition' : (arg_0: CollectParams) => Promise<
      ResponseResult_1
    >,
  ...
  'decreaseLiquidity' : (arg_0: DecreaseLiquidityParams) => Promise<
      ResponseResult_1
    >,
  'decreaseLiquidityInInvalidPosition' : (
      arg_0: DecreaseLiquidityParams,
  ...
  'increaseLiquidity' : (arg_0: IncreaseLiquidityParams) => Promise<
      ResponseResult_5
    >,
