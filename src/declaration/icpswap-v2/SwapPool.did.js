export const idlFactory = ({ IDL }) => {
  ...
  const SwapPool = IDL.Service({
    ...
    'increaseObservationCardinalityNext' : IDL.Func(
        [Type__3],
        [TextResult],
        [],
      ),
    ...
    'lockPool' : IDL.Func([], [], []),
    'mint' : IDL.Func(
        [IDL.Principal, Type, Type, Type__1, IDL.Nat, IDL.Nat],
        [ResponseResult_2],
        [],
      ),
    'quoter' : IDL.Func(
    ...
    'swap' : IDL.Func(
        [IDL.Principal, IDL.Int, IDL.Nat, IDL.Bool, IDL.Nat, IDL.Nat],
        [ResponseResult],
        [],
      ),
