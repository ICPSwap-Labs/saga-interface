...
export type ResponseResult_3 = { 'ok' : Array<string> } |
  { 'err' : string };
export type ResponseResult_4 = { 'ok' : ResultAmount } |
  { 'err' : string };
...
export interface SwapPool {
  ...
  'burn' : (arg_0: bigint, arg_1: bigint, arg_2: bigint) => Promise<
      ResponseResult_2
    >,
  ...
  'increaseObservationCardinalityNext' : (arg_0: Type__3) => Promise<
      TextResult
    >,
  ...
  'snapshotCumulativesInside' : (arg_0: Type, arg_1: Type) => Promise<
