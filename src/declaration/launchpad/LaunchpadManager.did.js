export const idlFactory = ({ IDL }) => {
  ...
  const LaunchpadCanister = IDL.Service({
    ...
    'computeFinalTokenViewSet' : IDL.Func(
        [IDL.Nat, IDL.Nat],
        [TokenViewSet],
        [],
      ),
    ...
    'install' : IDL.Func(
        [Property, IDL.Text, IDL.Vec(IDL.Text)],
        [BoolResult],
        [],
      ),
    'transferByAddress' : IDL.Func(
        [IDL.Principal, IDL.Principal, IDL.Nat, IDL.Text, IDL.Text],
        [IDL.Bool],
        [],
      ),
  ...
  const LaunchpadManager = IDL.Service({
    ...
    'getLaunchpadCanisters' : IDL.Func(
        [],
        [IDL.Vec(LaunchpadCanister)],
        ['query'],
      ),
    'getTicketPackage' : IDL.Func(
        [IDL.Text, IDL.Text],
        [ResponseResult_4],
        ['query'],
      ),
    ...
    'install' : IDL.Func(
        [IDL.Principal, Property, IDL.Vec(IDL.Text)],
        [ResponseResult_1],
        [],
      ),
