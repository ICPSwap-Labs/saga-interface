export const idlFactory = ({ IDL }) => {
  ...
  const SwapNFT = IDL.Service({
    ...
    'findTokenListByPool' : IDL.Func(
        [User, IDL.Text, IDL.Nat, IDL.Nat],
        [Result_15],
        ['query'],
      ),
    ...
    'getAllowances' : IDL.Func(
        [],
        [IDL.Vec(IDL.Tuple(TokenIndex, IDL.Vec(AccountIdentifier)))],
        ['query'],
      ),
    ...
    'initNFTCanisterInfo' : IDL.Func(
        [CanisterInfo, TokenIndex, IDL.Text],
        [Result_1],
        [],
      ),
    'isApproveForAll' : IDL.Func([IDL.Text, IDL.Text], [Result_3], ['query']),
    'isApproveForToken' : IDL.Func(
        [TokenIndex, IDL.Text, IDL.Text],
        [Result_8],
        ['query'],
      ),
