...
export type ResponseResult = { 'ok' : Page } |
  { 'err' : string };
export type ResponseResult_1 = { 'ok' : Balance__1 } |
  { 'err' : string };
export type ResponseResult_2 = { 'ok' : TokenIndex } |
  { 'err' : string };
export type ResponseResult_3 = { 'ok' : IcsMetadata } |
  { 'err' : string };
export type ResponseResult_4 = { 'ok' : Array<string> } |
  { 'err' : string };
export type ResponseResult_5 = { 'ok' : Page_1 } |
  { 'err' : string };
export type ResponseResult_6 = { 'ok' : Page_2 } |
  { 'err' : string };
export type ResponseResult_7 = { 'ok' : [string, string] } |
  { 'err' : string };
export type Result = {
...
export interface _SERVICE {
  ...
  'allowable' : () => Promise<[bigint, bigint, boolean]>,
  ...
  'computeSupply' : () => Promise<ResponseResult_2>,
  ...
  'mint' : (arg_0: IcsMintRequest) => Promise<ResponseResult_2>,
  'mintNFT' : (arg_0: MintRequest) => Promise<TokenIndex>,
  'mint_batch' : (arg_0: IcsMintRequests) => Promise<ResponseResult_2>,
  'nextTokenId' : () => Promise<TokenIndex>,
  ...
  'setCanisterId' : (arg_0: [] | [string], arg_1: [] | [string]) => Promise<
      BoolResult
    >,
